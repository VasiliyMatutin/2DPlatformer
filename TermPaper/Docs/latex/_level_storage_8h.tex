...
\begin{DoxyCompactList}\small\item\em Class-\/container which contains information about objects on the \hyperlink{class_level}{Level}. \end{DoxyCompactList}\end{DoxyCompactItemize}
