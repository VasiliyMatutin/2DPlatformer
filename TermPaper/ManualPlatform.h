...
public:
	...
	*/
	ManualPlatform(int _level_width, int _level_height, b2Body* _body, Object* _object, std::vector<std::pair<double, double>> _traj_coord, int _fixed_speed, bool _is_rounded, int _node_number);
	///inherited from Platform class
	void update();
	///inherited from ManualSwitchObj class
